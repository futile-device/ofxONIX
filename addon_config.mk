...
meta:
	ADDON_NAME = ofxONI
	ADDON_DESCRIPTION = ofxFutilities is my application framework
	ADDON_AUTHOR = @gameover (matt gingold)
	ADDON_TAGS = "addon" "application framework"
...
common:
	...
	# ...
	ADDON_LIBS += libs/liboni/lib/vs/liboni.lib
	ADDON_LIBS += libs/liboni/lib/vs/onidriver_riffa.lib
	ADDON_LIBS += libs/liboni/lib/vs/riffa.lib
...
vs:
	...
	# ADDON_DLLS_TO_COPY = 
	ADDON_DLLS_TO_COPY = libs/liboni/lib/vs/liboni.dll
	ADDON_DLLS_TO_COPY = libs/liboni/lib/vs/onidriver_riffa.dll
	ADDON_DLLS_TO_COPY = libs/liboni/lib/vs/riffa.dll
